...
def ways_coin_change_topdown(amount: int, denominations: list) -> int:
    ...
    return _ways_coin_change(len(denominations) - 1, amount, denominations, ways_value, None)
...
print(f"The number of ways to make change for {amount} units given denominations {denominations} is {ways_coin_change_topdown(amount, denominations)}.")